...
<?php
$feed1 = new SimplePie();
$feed1->set_feed_url('http://seclists.org/rss/dailydave.rss');
...
<?php
$feed2 = new SimplePie();
$feed2->set_feed_url('http://seclists.org/rss/pauldotcom.rss');
...
<?php
$feed3 = new SimplePie();
$feed3->set_feed_url('http://seclists.org/rss/bugtraq.rss');
...
<?php
$feed4 = new SimplePie();
$feed4->set_feed_url('http://seclists.org/rss/fulldisclosure.rss');
...
<?php
$feed5 = new SimplePie();
$feed5->set_feed_url('http://seclists.org/rss/oss-sec.rss');
...
<?php
$feed6 = new SimplePie();
$feed6->set_feed_url('http://seclists.org/rss/metasploit.rss');
...
<?php
$feed7 = new SimplePie();
$feed7->set_feed_url('http://seclists.org/rss/snort.rss');
...
<?php
$feed8 = new SimplePie();
$feed8->set_feed_url('http://seclists.org/rss/wireshark.rss');
...
<?php
$feed9 = new SimplePie();
$feed9->set_feed_url('http://seclists.org/rss/microsoft.rss');
...
$feed10->set_feed_url('http://seclists.org/rss/pen-test.rss');
...
$feed11->set_feed_url('http://seclists.org/rss/nmap-dev.rss');
...
$feed12->set_feed_url('http://seclists.org/rss/nmap-announce.rss');
